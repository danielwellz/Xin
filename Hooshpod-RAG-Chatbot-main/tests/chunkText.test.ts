...
describe("chunkText", () => {
  ...
  it("splits paragraphs and respects chunk size", () => {
    const text = [
      ...
      "Paragraph three is extremely long and should be broken into multiple pieces because its length exceeds the limit we pass in for the size parameter. ".repeat(
        5
      ),
    ].join("\n\n");
